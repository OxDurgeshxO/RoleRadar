...
export const SKILL_DEFS: SkillDef[] = [
  ...
  { id: "system design", label: "system design & architecture", category: "Backend", patterns: ["system design", "software architecture", "high availability", "scalability", "distributed systems"] },
  { id: "firebase", label: "firebase", category: "Backend", patterns: ["firebase", "firestore"] },

  // --- Mobile ---
  { id: "react native", label: "react native", category: "Mobile", patterns: ["react native", "react-native", "expo"] },
  { id: "flutter", label: "flutter", category: "Mobile", patterns: ["flutter", "dart"] },
  { id: "swift", label: "swift & ios", category: "Mobile", patterns: ["swift", "ios development", "xcode", "swiftui", "uikit"] },
  { id: "kotlin", label: "kotlin & android", category: "Mobile", patterns: ["kotlin", "android development", "android studio", "jetpack compose"] },
  ...
  { id: "vector db", label: "vector databases", category: "Data", patterns: ["vector database", "vector db", "chromadb", "pinecone", "weaviate", "qdrant", "milvus", "pgvector"] },
  ...
  { id: "transformers", label: "transformers & llms", category: "AI/ML", patterns: ["transformers", "transformer", "hugging face", "huggingface", "bert", "gpt", "llm", "llms", "large language model", "large language models", "fine-tuning", "fine tuning"] },
  { id: "langchain", label: "langchain & llamaindex", category: "AI/ML", patterns: ["langchain", "lang chain", "llamaindex", "llama-index", "llama index", "langgraph"] },
  { id: "rag", label: "retrieval augmented generation (rag)", category: "AI/ML", patterns: ["rag", "retrieval-augmented generation", "retrieval augmented generation", "vector search", "semantic search"] },
  { id: "prompt engineering", label: "prompt engineering", category: "AI/ML", patterns: ["prompt engineering", "few-shot", "cot", "chain of thought", "system prompts", "prompting"] },
  ...
  { id: "terraform", label: "terraform & iac", category: "DevOps", patterns: ["terraform", "iac", "infrastructure as code", "ansible", "cloudformation"] },
  ...
  { id: "cybersecurity", label: "cybersecurity", category: "Security", patterns: ["cybersecurity", "cyber security", "infosec", "information security", "network security", "firewall"] },
  { id: "penetration testing", label: "penetration testing & ethical hacking", category: "Security", patterns: ["penetration testing", "pen testing", "pentest", "ethical hacking", "vulnerability assessment", "burp suite", "metasploit", "kali linux"] },
  { id: "siem", label: "siem & soc operations", category: "Security", patterns: ["siem", "soc", "splunk", "sentinel", "qradar", "incident response", "log analysis", "threat hunting"] },
  { id: "owasp", label: "owasp & app security", category: "Security", patterns: ["owasp", "appsec", "application security", "xss", "csrf", "sql injection", "secure coding"] },

  // --- Product & Management ---
  { id: "product management", label: "product management", category: "Product", patterns: ["product management", "prd", "product requirements", "user stories", "roadmap planning", "product strategy", "product lifecycle"] },
...
export const PARTIAL_SIGNALS: Record<string, string[]> = {
  ...
  microservices: ["rest api", "docker", "system design"],
  "system design": ["microservices", "cloud deployment", "rest api"],
  ...
  langchain: ["transformers", "python", "prompt engineering"],
  rag: ["langchain", "vector db", "transformers"],
  "vector db": ["sql", "mongodb", "rag"],
  "prompt engineering": ["transformers", "nlp"],
  ...
  terraform: ["cloud deployment", "aws", "azure", "docker"],
  "ci/cd": ["git", "docker"],
  aws: ["azure", "gcp"],
  azure: ["aws", "gcp"],
  gcp: ["aws", "azure"],
  "cloud deployment": ["aws", "azure", "gcp", "docker", "ci/cd", "firebase"],
  cybersecurity: ["owasp", "penetration testing", "linux"],
  "penetration testing": ["cybersecurity", "linux", "owasp"],
  siem: ["cybersecurity", "linux"],
  owasp: ["cybersecurity", "rest api"],
  "product management": ["agile", "data analysis"],
  mongodb: ["sql"],
  mysql: ["sql"],
  postgresql: ["sql"],
  linux: ["git"],
